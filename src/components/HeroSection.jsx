    ...
    return (
        <section className="hero-section">
            ...
            <div className="hero-content">
                ...
                <p>Born from our own struggles as university students, Dalilak is a student-made platform built to help others find what we once couldn’t .</p>
                <button className="cta-button">Your academic journey just got easier →</button>
